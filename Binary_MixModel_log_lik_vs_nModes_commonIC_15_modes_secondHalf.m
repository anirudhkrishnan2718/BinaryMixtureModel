...
train_set_1 = sample_in_unshuffled_secondHalf;
test_set_1 = sample_in_unshuffled_secondHalf;
...
save('CommonIC_15_Folds_1_EMIter_500_log_lik_vs_nModes_singleVal_35_secondHalf.mat', 'n_modes_values', 'avg_log_lik_overFolds', 'w_dumpArray', 'm_dumpArray')
save('TrainTestSets_RandomPermute_singleVal_35_secondHalf.mat', 'train_set_1', 'test_set_1')
